...
const stripePromise = loadStripe("pk_test_51S3e78JxgyGSTjPPsAzLIF7HInYzNL066Id0REnF4N8MbyNzY21tZnfSYXzjZ5s03pckRhZmko3ZDhPJUdr0E9AJ00J1JE3imJ");
        ...
        <table>
          <tbody>
            <tr>
              ...
              <td id="intent-id" class="TableContent">{paymentIntentId}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td id="session-status" class="TableContent">{paymentStatus}</td>
            </tr>
            <tr>
              <td class="TableLabel">Payment Intent Status</td>
              <td id="payment-intent-status" class="TableContent">{paymentIntentStatus}</td>
            </tr>
          </tbody>
        </table>
      </div>
